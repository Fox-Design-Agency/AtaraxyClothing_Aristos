...
router.post("/add-product", function (req, res) {
    ...
    let description = req.body.keywords;
            ...
            Product.findOne({ slug: slug }, function (err, product) {
                if (product) {
                    ...
                    product.save(function (err) {
                        ...
                        mkdirp("content/public/images/product_images/" + product._id, function (err) {
                            if (err) { console.log(err) };
                        })
                        mkdirp("content/public/images/product_images/" + product._id + "/gallery", function (err) {
                            if (err) { console.log(err) };
                        })
                        mkdirp("content/public/images/product_images/" + product._id + "/gallery/thumbs", function (err) {
                            if (err) { console.log(err) };
                        })
